; ¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
    ...
    tcol equ <002A2A2Ah>                ; title bar back colour
...
entry_point proc
    ...
    mov hBrush,    rvcall(CreateSolidBrush,00383838h)
...
WndProc proc hWin:QWORD,uMsg:QWORD,wParam:QWORD,lParam:QWORD
    ...
    .switch uMsg
      ...
      ; -------------------
        ...
        mov hLabel2, rv(transparent_label,hInstance,hWin,"Copyright © The MASM32 SDK 1997 - 2018",indl,70,400,20,0,DT_LEFT)
